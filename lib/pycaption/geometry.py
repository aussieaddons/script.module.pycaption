...
class Size(object):
    ...
    def as_percentage_of(self, video_width=None, video_height=None):
        ...
        if unit == UnitEnum.EM:
            ...
            # have no access. As a workaround, we presume the font-size is
            # 16px,
    ...
    def from_string(cls, string):
        ...
        if unit is not None:
            ...
            raise ValueError(
                ...
                u"The only supported units are: {supported}".format(
                    value=raw_number,
...
class Padding(object):
    ...
    None. If this is not true Writers may fail for they rely on this
    assumption.
    """
...
class Layout(object):
    ...
    def fit_to_screen(self):
        ...
        returned by as_percentage_of). All units are presumed to be
        percentages.
        """
